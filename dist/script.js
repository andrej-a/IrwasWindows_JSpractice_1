...
window.addEventListener("DOMContentLoaded", function () {
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["modalWindow"])( //popupEngineerButton
  {
    buttonOpenSelectorItem: ".popup_engineer_btn",
    modalSelectorItem: ".popup_engineer",
    buttonCloseSelectorItem: ".popup_close strong"
  });
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["modalWindow"])( //backCallButton
  {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["tabs"])({
...
/* harmony import */ var _service_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../service/service */ "./src/js/service/service.js");
...
function forms(formSelector, formInputSelector) {
  ...
  function sendForms(form) {
    form.addEventListener("submit", function (event) {
      ...
      Object(_service_service__WEBPACK_IMPORTED_MODULE_10__["postDataFormToServer"])("http://localhost:3000/callingMaster", json, box, message.waiting).then(function (result) {
        console.log(result);
        box.innerText = "".concat(result.user_name, ", \u0441\u043F\u0430\u0441\u0438\u0431\u043E! ").concat(message.done);
      }).catch(function () {
        box.innerText = message.error;
      }).finally(function () {
        setTimeout(function () {
          if (event.target.matches(".buttonFormEngineer")) {
            Object(_service_service__WEBPACK_IMPORTED_MODULE_10__["closeModal"])(document.querySelector(".popup_engineer"));
          } else if (event.target.matches(".buttonForm")) {
            Object(_service_service__WEBPACK_IMPORTED_MODULE_10__["closeModal"])(document.querySelector(".popup"));
          }
        }, 3000);
        resetTimer(form, box);
      });
  ...
  var resetTimer = function resetTimer(resetForm, removeBox) {
    setTimeout(function () {
      resetForm.reset();
...
function modalWindow(_ref) {
  ...
  var parentModalWindow = document.querySelector(modalSelectorItem);
  var timer = null;
  openModalScroll();
  openModalTimer();
  ...
  parentModalWindow.addEventListener("click", function (e) {
    if (e.target.matches(modalSelectorItem) || e.target.matches(buttonCloseSelectorItem)) {
      Object(_service_service__WEBPACK_IMPORTED_MODULE_1__["closeModal"])(modalWindow);
    }
  });
...
function tabs(_ref) {
  var blockSelector = _ref.blockSelector,
      contentSelector = _ref.contentSelector,
      classActiveSelector = _ref.classActiveSelector,
...
/*!***********************************!*\
  !*** ./src/js/service/service.js ***!
  \***********************************/
/*! exports provided: postDataFormToServer, closeModal, openModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
